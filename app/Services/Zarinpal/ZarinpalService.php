...
class ZarinpalService
{
    ...
    public function request($Amount, $Description = null, $Email = null, $Mobile = null, $CallbackURL)
    {
        $MerchantID = config('services.zarinpal.merchantID');

        [$SandBox, $ZarinGate] = [config('services.zarinpal.sandbox'), config('services.zarinpal.zarinGate')];
