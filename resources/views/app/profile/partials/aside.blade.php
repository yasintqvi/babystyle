<div class="md:w-1/4 w-full md:pl-2 mb-4">
    <div class="border rounded-lg sticky top-0 p-5">
        <div class="divide-y">
            ...
            <a href="{{ route('profile.orders.tracking') }}"
                class="flex {{ isActiveLink('profile.orders.tracking') ? 'text-primary' : '' }} items-center py-3 text-sm gap-2 text-gray-600">
                <span>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="w-5">
                        <path stroke-linecap="round" stroke-linejoin="round"
