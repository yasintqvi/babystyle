    ...
    <div class="container flex flex-wrap py-5">
        ...
        <div class="md:w-3/4 w-full md:pr-2 space-y-4">
            ...
            <div class="border rounded-lg p-5 shadow">
                ...
                <div id="repeatedly" class="w-full swiper mb-3 md:mb-0 my-8">
                    <button type="button"
                        class="repeatedly-button-prev rotate-180 md:bg-primary w-10 h-10 py-2 px-2 md:ml-2 mb-2 flex items-center text-xs font-medium focus:outline-none rounded-xl hover:bg-primary focus:z-10 md:focus:ring-2 focus:ring-yellow-600 group absolute top-1/2 -translate-y-1/2 right-0 z-10">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="w-20 h-20 text-yellow-900 md:text-white group-hover:text-white">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 19.5L8.25 12l7.5-7.5" />
                        </svg>
                    ...
                    <button type="button"
                        class="repeatedly-button-next rotate-180 md:bg-primary w-10 h-10 py-2 px-2 md:mr-2 mb-2 flex items-center text-xs font-medium focus:outline-none rounded-xl hover:bg-primary focus:z-10 md:focus:ring-2 focus:ring-yellow-600 group absolute top-1/2 -translate-y-1/2 left-0 z-10">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="w-20 h-20 text-yellow-900 md:text-white group-hover:text-white">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
                        </svg>
