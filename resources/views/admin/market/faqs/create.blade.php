...
@section('content')
    ...
    <div class="nk-block-between mb-4 mt-2">
        <div class="nk-block-head-content">
            <h3 class="nk-block-title page-title">ایجاد سوال </h3>
        </div>
        <!-- .nk-block-head-content -->
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <input type="text" class="form-control" placeholder="مثال : چطور می‌توانم سفارشم را پیگیری کنم؟" id="fv-full-name" name="question"
                                    value="{{ old('question') }}">
                            </div>
                            @error('question')
