@extends('admin.layouts.app', ['title' => 'اسلایدر ها'])
...
@section('content')
            ...
            <div class="nk-block-head nk-block-head-sm">
                <div class="nk-block-between">
                    <div class="nk-block-head-content">
                        <h3 class="nk-block-title page-title">اسلایدر ها</h3>
                    </div>
                            ...
                            <div class="toggle-expand-content" data-content="pageMenu">
                                <ul class="nk-block-tools g-3">
                                        ...
                                        <div class="drodown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                <ul class="link-list-opt no-bdr">
                                                    <li>
                                                        <a href="{{ route('admin.market.sliders.fetch') }}?paginate=10"
                                                            onclick="filterRequest(event, this)"><span>15</span></a>
                                                    </li>
                                                    <li>
                                                        <a href="{{ route('admin.market.sliders.fetch') }}?paginate=25"
                                                            onclick="filterRequest(event, this)"><span>25</span></a>
                                                    </li>
                                                    <li>
                                                        <a href="{{ route('admin.market.sliders.fetch') }}?paginate=50"
                                                            onclick="filterRequest(event, this)"><span>50</span></a>
                                                    </li>
                                                    <li>
                                                        <a href="{{ route('admin.market.sliders.fetch') }}?paginate=100"
                                                            onclick="filterRequest(event, this)"><span>100</span></a>
                                                    </li>
                                                    <li>
                                                        <a href="{{ route('admin.market.sliders.fetch') }}?paginate=250"
                                                            onclick="filterRequest(event, this)"><span>250</span></a>
                                                    </li>
                                                    <li>
                                                        <a href="{{ route('admin.market.sliders.fetch') }}?paginate=500"
                                    ...
                                    <li>
                                        <div class="drodown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                <ul class="link-list-opt no-bdr">
                                                    <li>
                                                        <a href="{{ route('admin.market.sliders.fetch') }}"
                                                            onclick="filterRequest(event, this)"><span>همه</span></a>
                                                    </li>
                                                    <li>
                                                        <a href="{{ route('admin.market.sliders.fetch') }}?status=active"
                                                            onclick="filterRequest(event, this)"><span>فعال</span></a>
                                                    </li>
                                                    <li>
                                                        <a href="{{ route('admin.market.sliders.fetch') }}?status=not-active"
                                    ...
                                    <li class="nk-block-tools-opt">
                                        <a href="{{ route('admin.market.sliders.create') }}"
    ...
    <form action="{{ route('admin.market.sliders.batch-delete') }}" method="post" class="nk-tb-list is-separate mb-3"
        id="table-container">
    ...
    <script id="table-template" type="text/x-handlebars-template">
        <div class="nk-tb-item nk-tb-head">
            ...
            <div class="nk-tb-col"><span>توضیح تصویر</span></div>
        ...
        {{#each data}}
            <div class="nk-tb-item">
                <div class="nk-tb-col nk-tb-col-check">
                    <div class="custom-control custom-control-sm custom-checkbox notext">
                        <input type="checkbox" name="ids[]" data-edit="/admin/market/sliders/{{ id }}/edit" value="{{ id }}" class="custom-control-input batch-inputs" id="id-{{ id }}" />
                ...
                <div class="nk-tb-col">
                    <span class="tb-product">
                        ...
                        <label for="id-{{ id }}" class="title">{{alt}}</label>
                    </span>
                </div>
                <div class="nk-tb-col nk-tb-col-tools">
                    <ul class="nk-tb-actions gx-1">
                        ...
                        <li class="nk-tb-action">
                            <a href="/admin/market/sliders/{{ id }}/edit"
...
@section('script')
    ...
    <script>
        'use strict'
        const defaultUrl = "{{ route('admin.market.sliders.fetch') }}";
