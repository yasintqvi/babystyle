     ...
     <!-- .nk-block-head-content -->
            <div class="nk-block-between mb-4 mt-2">
                <div class="nk-block-head-content">
                    <h3 class="nk-block-title page-title">ویرایش اسلایدر </h3>
                </div>
                <!-- .nk-block-head-content -->
                <div class="nk-block-head-content">
                        ...
                        <div class="toggle-expand-content" data-content="pageMenu">
                            <ul class="nk-block-tools g-3">
                                <li class="nk-block-tools-opt">
                                    ...
                                    <a href="{{ route('admin.market.sliders.index') }}" type=""
...
<div class="card">
    <div class="card-inner">
        <form action="{{ route('admin.market.sliders.update' , $slider->id)}}" method="post" enctype="multipart/form-data" id="form" class="form-validate" novalidate="novalidate">
            @csrf
            {{ method_field('put') }}
            <div class="row g-gs">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                            <input type="text" class="form-control" id="fv-full-name" name="alt" value="{{ old('alt' , $slider->alt) }}">
                        </div>
                        @error('alt')
