@extends('admin.layouts.app', ['title' => 'کد تخفیف'])
...
@section('content')
            ...
            <div class="nk-block-head nk-block-head-sm">
                <div class="nk-block-between">
                    <div class="nk-block-head-content">
                        <h3 class="nk-block-title page-title">کد تخفیف</h3>
                    </div>
                            ...
                            <div class="toggle-expand-content" data-content="pageMenu">
                                <ul class="nk-block-tools g-3">
                                        ...
                                        <div class="drodown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                <ul class="link-list-opt no-bdr">
                                                    <li>
                                                        <a href="{{ route('admin.market.discount-codes.fetch') }}?paginate=10"
                                                            onclick="filterRequest(event, this)"><span>15</span></a>
                                                    </li>
                                                    <li>
                                                        <a href="{{ route('admin.market.discount-codes.fetch') }}?paginate=25"
                                                            onclick="filterRequest(event, this)"><span>25</span></a>
                                                    </li>
                                                    <li>
                                                        <a href="{{ route('admin.market.discount-codes.fetch') }}?paginate=50"
                                                            onclick="filterRequest(event, this)"><span>50</span></a>
                                                    </li>
                                                    <li>
                                                        <a href="{{ route('admin.market.discount-codes.fetch') }}?paginate=100"
                                                            onclick="filterRequest(event, this)"><span>100</span></a>
                                                    </li>
                                                    <li>
                                                        <a href="{{ route('admin.market.discount-codes.fetch') }}?paginate=250"
                                                            onclick="filterRequest(event, this)"><span>250</span></a>
                                                    </li>
                                                    <li>
                                                        <a href="{{ route('admin.market.discount-codes.fetch') }}?paginate=500"
                                    ...
                                    <li>
                                        <div class="drodown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                <ul class="link-list-opt no-bdr">
                                                    <li>
                                                        <a href="{{ route('admin.market.discount-codes.fetch') }}"
                                                            onclick="filterRequest(event, this)"><span>همه</span></a>
                                                    </li>
                                                    <li>
                                                        <a href="{{ route('admin.market.discount-codes.fetch') }}?status=active"
                                                            onclick="filterRequest(event, this)"><span>فعال</span></a>
                                                    </li>
                                                    <li>
                                                        <a href="{{ route('admin.market.discount-codes.fetch') }}?status=not-active"
                                    ...
                                    <li class="nk-block-tools-opt">
                                        <a href="{{ route('admin.market.discount-codes.create') }}"
                                            class="btn btn-icon btn-primary d-md-none"><em class="icon ni ni-plus"></em></a>
                                        <a href="{{ route('admin.market.discount-codes.create') }}"
                                            class="btn btn-primary d-none d-md-inline-flex"><em
                                                class="icon ni ni-plus"></em><span>افزودن کد تخفیف </span></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
    ...
    <form action="{{ route('admin.market.discount-codes.batch-delete') }}" method="post" class="nk-tb-list is-separate mb-3"
    id="table-container">
...
<script id="table-template" type="text/x-handlebars-template">
    <div class="nk-tb-item nk-tb-head">
        ...
        <div class="nk-tb-col"><span>کد تخفیف</span></div>
        <div class="nk-tb-col"><span>انتشار</span></div>
        <div class="nk-tb-col"><span>نوع تخفیف</span></div>
    ...
    {{#each data}}
        <div class="nk-tb-item">
            <div class="nk-tb-col nk-tb-col-check">
                <div class="custom-control custom-control-sm custom-checkbox notext">
                    <input type="checkbox" name="ids[]" data-edit="/admin/market/discount-codes/{{ id }}/edit" value="{{ id }}" class="custom-control-input batch-inputs" id="id-{{ id }}" />
            ...
            <div class="nk-tb-col">
                <span class="tb-product">
                    <label for="id-{{ id }}" class="title">{{code}} </label>
                </span>
            </div>

            <div class="nk-tb-col">
                <span class="tb-product">
                    <label for="id-{{ id }}" class="badge bg-info" class="title">{{start_date_status}}
                </span>
            </div>

            <div class="nk-tb-col">
                <span class="tb-product">
                    <label for="id-{{ id }}" class="title">
                        {{#if type}}
                            <span  class="badge-dim bg-outline-secondary px-1">مبلغی</span>
                        {{else}}
                            <span class="badge-dim bg-outline-primary px-1">درصدی</span>
                        {{/if}}
                </span>
            </div>
            ...
            <div class="nk-tb-col nk-tb-col-tools">
                <ul class="nk-tb-actions gx-1">
                    ...
                    <li class="nk-tb-action">
                        <a href="/admin/market/discount-codes/{{ id }}/edit"
...
@section('script')
    ...
    <script>
        'use strict'
        const defaultUrl = "{{ route('admin.market.discount-codes.fetch') }}";
