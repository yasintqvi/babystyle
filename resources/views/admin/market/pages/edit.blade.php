@extends('admin.layouts.app', ['title' => 'ویرایش صفحه'])
...
@section('content')
    ...
    <div class="nk-block-between mb-4 mt-2">
        <div class="nk-block-head-content">
            <h3 class="nk-block-title page-title">ویرایش صفحه </h3>
        </div>
        <!-- .nk-block-head-content -->
    ...
    <div class="card">
        <div class="card-inner">
            <form action="{{ route('admin.market.pages.update' , $page->id) }}" method="post" enctype="multipart/form-data"
