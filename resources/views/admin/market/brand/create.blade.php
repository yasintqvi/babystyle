...
<ul class="breadcrumb breadcrumb-arrow">
    ...
    <div class="nk-block-head-sub mt-1 col-md-6">
        <a class="back-to" href="{{ route('admin.market.brands.index')}}"><em class="icon ni ni-arrow-left"></em><span>بازگشت</span></a>
    </div>

    <div class="nk-block-head col-md-6">
        <div class="nk-block-head-content">
            <h4 class="title nk-block-title">ایجاد برند</h4>
        </div>
    </div>
            ...
            <div class="row g-gs">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                            <input type="text" class="form-control" id="fv-full-name" name="persian_name">
                        </div>
                        @error('persian_name')
                ...
                <div class="col-md-6">
                    <div class="form-group ">
                        ...
                        <div class="form-control-wrap">
                            <input type="text" class="form-control" id="fv-full-name" name="original_name">
                        </div>
                        @error('original_name')
                            <span class="alert_required text-danger xl-1 p-1 rounded" role="alert">
                                <strong>
