...
@section('content')
            ...
            <div class="nk-block-head nk-block-head-sm">
                <div class="nk-block-between">
                    <div class="nk-block-head-content">
                        <h3 class="nk-block-title page-title">برند ها</h3>
                    </div>
                                        ...
                                        <div class="drodown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                <ul class="link-list-opt no-bdr">
                                                    <li>
                                                        <a href="{{ route('admin.market.brands.fetch') }}?paginate=10"
                                                            onclick="filterRequest(event, this)"><span>15</span></a>
                                                    </li>
                                                    <li>
                                                        <a href="{{ route('admin.market.brands.fetch') }}?paginate=25"
                                                            onclick="filterRequest(event, this)"><span>25</span></a>
                                                    </li>
                                                    <li>
                                                        <a href="{{ route('admin.market.brands.fetch') }}?paginate=50"
                                                            onclick="filterRequest(event, this)"><span>50</span></a>
                                                    </li>
                                                    <li>
                                                        <a href="{{ route('admin.market.brands.fetch') }}?paginate=100"
                                                            onclick="filterRequest(event, this)"><span>100</span></a>
                                                    </li>
                                                    <li>
                                                        <a href="{{ route('admin.market.brands.fetch') }}?paginate=250"
                                                            onclick="filterRequest(event, this)"><span>250</span></a>
                                                    </li>
                                                    <li>
                                                        <a href="{{ route('admin.market.brands.fetch') }}?paginate=500"
    ...
    <form action="{{ route('admin.market.brands.batch-delete') }}" method="post" class="nk-tb-list is-separate mb-3"
        id="table-container">
    ...
    <script id="table-template" type="text/x-handlebars-template">
        <div class="nk-tb-item nk-tb-head">
            ...
            <div class="nk-tb-col"><span>نام فارسی</span></div>
            <div class="nk-tb-col"><span>نام اورجینال</span></div>
        ...
        {{#each data}}
            <div class="nk-tb-item">
                <div class="nk-tb-col nk-tb-col-check">
                    <div class="custom-control custom-control-sm custom-checkbox notext">
                        <input type="checkbox" name="ids[]" data-edit="/admin/market/brands/{{ id }}/edit" value="{{ id }}" class="custom-control-input batch-inputs" id="id-{{ id }}" />
                ...
                <div class="nk-tb-col">
                    <span class="tb-product">
                        ...
                        <label for="id-{{ id }}" class="title">{{persian_name}}</label>
                    </span>
                </div>
                <div class="nk-tb-col">
                    <span class="tb-product">
                        <label for="id-{{ id }}" class="title">{{original_name}}</label>
                    </span>
                </div>
                <div class="nk-tb-col nk-tb-col-tools">
...
@section('script')
    ...
    <script>
        'use strict'
        const defaultUrl = "{{ route('admin.market.brands.fetch') }}";
