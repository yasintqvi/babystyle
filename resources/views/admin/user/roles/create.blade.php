@extends('admin.layouts.app', ['title' => 'ایجاد نقش'])
...
@section('content')
    ...
    <div class="nk-block">
        <form class="row g-gs" action="{{ route('admin.user.roles.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
                        ...
                        <div class="row ">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label" for="fv-first-name">عنوان نقش :</label>
