                            ...
                            <div class="card-inner">
                                <div class="col-lg-7">
                                    ...
                                    <ul class="custom-control-group">
                                        ...
                                        <li>
                                            <div class="custom-control custom-checkbox custom-control-pro no-control">
                                                <input type="checkbox" name="phone_verified_at" class="custom-control-input" name="phone_verified_at"
                                                    id="btnIconRadio2" value="1" @checked(old('phone_verified_at'))>
                            ...
                            <div class="row g-gs">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input type="number" class="form-control" id="fv-phone"
